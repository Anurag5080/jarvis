...
def run_jarvis():
    ...
    if 'play' in command:
        ...
        talk('Hello, I am Jarvis. I am a Ai voice bot made by Anurag Singh. I can help you. Say something')
        ...
        talk("I have been created by Anurag.")
    elif "who am i" in command:
        command("If you talk then definitely your human.")
    elif "why you came to world" in command:
        talk("Thanks to Anurag. further It's a secret")
    elif "who are you" in command:
        talk("I am your virtual assistant created by Anurag")
    elif 'reason for you' in command:
        talk("I was created as a Minor project by Mister Anurag")
